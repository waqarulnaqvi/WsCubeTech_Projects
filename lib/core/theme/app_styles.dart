...
class AppStyles {
  ...
  static TextStyle descriptionPrimary({double fontSize = 18, FontWeight fontWeight = FontWeight.w400, required BuildContext context,Color? color, TextDecoration decoration = TextDecoration.none , Color? decorationColor}) {
    return TextStyle(
      fontFamily: 'Poppins',
      color:color?? Theme.of(context).colorScheme.surface,
      fontSize: fontSize,
