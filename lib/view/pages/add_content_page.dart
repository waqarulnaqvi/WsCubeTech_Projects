...
import 'package:todo_app_bloc/core/theme/app_gradients.dart';
import 'package:todo_app_bloc/model/todo_model.dart';
import 'package:todo_app_bloc/utils/priority_type.dart';
import 'package:todo_app_bloc/view/widgets/global_widgets.dart';
import 'package:todo_app_bloc/view/widgets/text_view/reusable_text_field.dart';
...
class _AddContentPageState extends State<AddContentPage> {
  ...
  void isUpdateContent() {
    if (widget.todoModel != null) {
      ...
      context.read<TodoBloc>().add(
        TodoBlocPriorityChangedEvent(
          newPriority: PriorityType.intToString(widget.todoModel!.priority),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    var rCubit = context.read<TodoBloc>();
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropDownButton(
                heading: context.watch<TodoBloc>().currentPriority,
                onChanged: (value) {
                  if (value != null) {
                    ...
                    rCubit.add(TodoBlocPriorityChangedEvent(newPriority: value));
                    // print(rCubit.priority);
                  }
                },
                    ...
                    context.read<TodoBloc>().add(
                      TodoBlocUpdateEvent(
                        updatedTodo: TodoModel(
                          ...
                          title: titleController.text,
                          description: descriptionController.text,
                          priority: PriorityType.stringToInt(rCubit.currentPriority),
                          isCompleted: isChecked,
                        ),
                      ),
                    );
